          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <select id="penyimpanan" class="custom-select" name="penyimpanan" required>
                  <option hidden value="<?= $data->penyimpanan?>"><?= $data->penyimpanan ?></option>
            ...
            <div class="form-group col-md-4">
              ...
              <select id="jenispenyimpanan" class="custom-select" name="jenispenyimpanan" required>
                  <option hidden value="<?= $data->jenispenyimpanan?>"><?= $data->jenispenyimpanan ?></option>
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-4">
            ...
            <div class="card card-body p-2">
              ...
              <input type="text" name="tmp_fotoProduk" value="<?= $row->foto_produk ?>" hidden>
            </div>
          </div>
        </div>

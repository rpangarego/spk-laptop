<div class="mt-3 mb-4">
	<span class="h3">Tambah Memori (RAM)</span>
</div>
...
<div class="col-md-3">
	...
	<form method="POST">
    	<div class="form-group">
	        <label for="memori">Memori (RAM)</label>
	        <input type="text" class="form-control" id="memori" name="memori" required autocomplete="off" autofocus>
      	</div>	
